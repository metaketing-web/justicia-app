  ...
  if (finished) {
    ...
    return (
      <div className="max-w-md mx-auto bg-neutral-900 border border-neutral-700 rounded-xl p-8 shadow-lg text-center animate-fadeIn">
        ...
        <button onClick={handleRestart} className="px-4 py-2 bg-justicia-gradient text-white hover:text-black rounded hover:bg-justicia-gradient/80 transition">Retake Quiz</button>
      ...
      <div className="flex flex-col gap-3">
        {q.options.map((opt, i) => (
          <button
            ...
            className="px-4 py-2 bg-justicia-gradient/80 text-white rounded hover:bg-justicia-gradient transition"
          >
            {opt}
          </button>
        ))}

...
const DocumentsListNew: React.FC<DocumentsListNewProps> = ({ onClose, onOpenDocument }) => {
  ...
  const [sharingDocumentTitle, setSharingDocumentTitle] = useState('');
    ...
    <div className="fixed inset-0 bg-black/80 backdrop-blur-sm z-50 flex items-center justify-center p-4">
                ...
                >
                  <div className="flex items-start justify-between">
                    ...
                    <div className="flex gap-2">
                      ...
                      <button
                        onClick={() => {
                          setSharingDocumentId(doc.id);
                          setSharingDocumentTitle(doc.title);
                        }}
                        className="p-2 hover:bg-neutral-700 rounded-lg transition-colors group"
                        title="Partager"
                      >
      ...
      {sharingDocumentId && (
        <DocumentShareModal
          ...
          documentTitle={sharingDocumentTitle}
          onClose={() => {
            setSharingDocumentId(null);
            setSharingDocumentTitle('');
          }}
        />
      )}
    </div>

    ...
    <div className="fixed inset-0 z-[10001] flex items-center justify-center bg-black/80 backdrop-blur animate-fadeIn">
      <div className="bg-neutral-900 p-6 rounded-xl shadow-2xl max-w-md w-full flex flex-col items-center">
        ...
        <canvas
          ...
          width={400}
          height={180}
          className="border border-justicia-gradient rounded bg-neutral-900 cursor-crosshair mb-4"
        ...
        <div className="flex gap-3 mb-4">
          ...
          <button className="px-4 py-2 bg-justicia-gradient text-white hover:text-black rounded font-semibold hover:bg-justicia-gradient/80 transition" onClick={handleSave}>Save</button>
        </div>

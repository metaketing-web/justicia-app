...
export const JusticiaLogo: React.FC<{showText?: boolean}> = ({ showText = true }) => (
    <div className="flex items-center gap-3">
        <img 
            src="/justicia-icon.png" 
            alt="Justicia" 
            width="32" 
            height="32" 
            className="flex-shrink-0"
        />
        {showText && <span className="text-xl font-bold text-white truncate">Justicia</span>}
    </div>
);

export const JusticiaIcon = () => (
...
export const FolderIcon: React.FC<{className?: string; style?: React.CSSProperties}> = ({className, style}) => (
  <IconWrapper className={className}>
    <path d="M22 19a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5l2 3h9a2 2 0 0 1 2 2z" style={style}></path>
  </IconWrapper>
);

export const FolderOpenIcon: React.FC<{className?: string; style?: React.CSSProperties}> = ({className, style}) => (
  <IconWrapper className={className}>
    <path d="M22 19a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5l2 3h9a2 2 0 0 1 2 2z" style={style}></path>
    <polyline points="2 11 4 19 20 19 22 11" style={style}></polyline>
  </IconWrapper>
);
